...
/*
 * Ϊ���� Python hashlib.md5 һ�£�����������һ���򵥵� MD5 ʵ�֡�
 * ����Ļ������� OpenSSL ������ MD5 �⣬����ֱ�ӵ��ÿ⺯����
 */
...
// ȫ�ֱ���
static long long nodes_explored = 0;       // ���������ѷ��ʵĽڵ���
static double search_start_time = 0.0;     // ����������ʼʱ�� (��)
static vector<string> spinner = {"|", "/", "-", "\\"}; // תȦ��������
...
// ��ά���̣�board[r][c] ��һ�� vector<char>����ʾ�ø�ѵ�����������
// ������ײ�Ϊ board[r][c][0], ���Ϊ board[r][c].back()
...
double evaluate(const vector<vector<vector<char>>>& board) {
    ...
    for (auto &lineCoords : lines) {
        ...
        // ����ģʽ�ַ������� Python һ�£�AI->'B', PLAYER->'W', ��->'-'��
        // ע�⣺Python ������ AI='W', PLAYER='B' (ʾ����)������Ը�����Ҫ������
        // ������Ϊ��ά��һ�£���Ҫ����ȷ�ϣ����涨�壺PLAYER='B', AI='W'��
        // Python ԭ��д���� PLAYER='B', AI='W'���� evaluate ��ȴд�� pattern �� 'B' if p==AI ...
        // ��ʵ Python ���ǣ�AI='W' => 'B' if p==AI ... �ƺ���һ��"��ת"��
        // ����ֻҪ�� black_pattern_score, white_pattern_score ��Ӧ�ü��ɡ�
        // �����ϸ����� Python �����е�д����
        ...
        for (char p : pieces) {
            if (p == AI) {
                // AI='W'������ pattern ��Ҫд 'B' ?
                // Python ����ȷʵ��ôд�ˣ� 'B' if p==AI ...
                // �⿴��ȥ��š�ͣ���Ϊ����ԭ Python �������һģһ����ֻ������
                pattern_oss << 'B';
            }
            else if (p == PLAYER) {
                // PLAYER='B' => �� pattern ��д 'W'
                pattern_oss << 'W';
            }
            else {
                pattern_oss << '-';
...
pair<double,pair<int,int>> minimax(
    ...
    if (nodes_explored % refresh_threshold == 0) {
        ...
        // \r�ص����׸���
        cerr << "\r\033[90m[AI����] " << spin_char
             << "  �ѷ��ʽڵ�=" << nodes_explored
             << ", ��ʱ=" << fixed << setprecision(2) << spent << "s\033[0m";
        cerr.flush();
    }
        ...
        if (current_player == PLAYER) {
            ...
            if (!ai_first_move_done) {
                ...
                if (mv.first != -1 && mv.second != -1) {
                    ...
                    cout << "\033[92m��AI��һ�֡�����: �� " << mv.first + 1 
                         << ", �� " << mv.second + 1 
                         << ", ��ʱ " << fixed << setprecision(2) << spent << "s, �ڵ�=" << nodes_explored << "\033[0m" 
                         << endl;
                }
                ...
                if (urgent_move.first != -1) {
                    ...
                    cout << "\033[92m��AI�������ԡ�����: �� " << urgent_move.first + 1
                         << ", �� " << urgent_move.second + 1 
                         << "\033[0m" << endl;
                } else {
                    // ������������
